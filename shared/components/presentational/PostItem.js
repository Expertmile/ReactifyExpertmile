...
export default class PostItem extends React.Component {
	...
	render() {
		const {posts, auth, onReadMore, onComment, handleShare, viewport960px, handleCommentDelete, onImprove, onHelpful, editable, onPostLike, onPostUnlike, handleMenuBar, handleCommentPanel } = this.props;
		...
		return (
			<div>
							...
							<div className="mdl-share-tabs-bar">
								<div className="col_xs_4">
									{	posts.get('liked') === null ? 
											<span onClick={onPostLike} className="mdl-share-tabs__tab">Like</span>
											:
								...
								<div className="col_xs_4"> 
									<span onClick={() => handleShare(posts.get('Status_Value'))} className="mdl-share-tabs__tab">Share</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div>
				{posts.get('comments').map((cid, index) => {
					return (
						<div key={index}>
				...
				<div className="hidden_xs hidden_md hidden_sm">
